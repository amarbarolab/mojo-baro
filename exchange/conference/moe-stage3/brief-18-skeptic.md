# Conference participant 18-skeptic

**Your framing line (the only thing that differs between participants):** Argues the strongest case that it is wrong. Fears untested claims that sounded right.

Your output file: `$HOME/Projects/mojo/mojo-baro/exchange/conference/moe-stage3/18-skeptic.md`
