...
"""SHA-256 (FIPS 180-4) implementation, vendored (U3, docs/design/latent-os/
09-roadmap.md "model universal" discussion): max._core_mojo.sha256 ships this
same code as build-tooling source, not an importable package (`mojo run`
cannot resolve `max._core_mojo`), so it is copied here rather than symlinked.
Used for weights_uuid (tensor-data digest), runtime and tokenizer_sha."""
