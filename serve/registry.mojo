...
from ssm import (
    ...
    amar_ssm_gated_out_rows_bf16, amar_ssm_delta_chunk_w, amar_ssm_delta_rows, DC_BLOCKS,
)
...
comptime deltar_p = amar_ssm_delta_rows[type_of(ssall_layout), type_of(convp_layout), type_of(g32p_layout), type_of(op_layout)]
