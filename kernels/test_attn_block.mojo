...
def main() raises:
    ...
    ctx.enqueue_function[append_k](Kc, Khd, tab_d.unsafe_ptr(), Int32(T_PRE), Int32(0), grid_dim=NKVH, block_dim=HD)
    ctx.enqueue_function[append_k](Vc, Vhd, tab_d.unsafe_ptr(), Int32(T_PRE), Int32(0), grid_dim=NKVH, block_dim=HD)
    ctx.enqueue_function[att_k](Q, Kc, Vc, O, tab_d.unsafe_ptr(), Int32(T), Float32(0.0625), Int32(0), grid_dim=NQH, block_dim=HD)
    ctx.enqueue_function[datt_k](Q, Kc, Vc, O2, tab_d.unsafe_ptr(), Int32(T), Float32(0.0625), Int32(0), grid_dim=NQH, block_dim=HD)
