...
| `amar_ssm_delta_step` | `ssm.mojo` | `MR: Int, S0Layout: TensorLayout, CLayout: TensorLayout, GLayout: TensorLayout, OLayout: TensorLayout, JSPLIT: Int = 1` |  | serve/registry.mojo, bench/bench_launch_floor.mojo, kernels/test_mega_block.mojo, kernels/test_prefill.mojo, kernels/test_ssm_block.mojo |
