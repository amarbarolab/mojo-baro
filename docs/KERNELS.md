...
| `amar_sample_row` | `sample.mojo` | `XLayout: TensorLayout, OLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | sample_row_k, sample_row_1 | serve/registry.mojo, serve/spark.mojo, bench/sample-spark-device.mojo, kernels/test_sample.mojo, kernels/test_sample_device.mojo, kernels/test_sample_mask.mojo, kernels/test_sample_pen.mojo |
| `amar_sample_row_masked` | `sample.mojo` | `XLayout: TensorLayout, OLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` |  | kernels/test_sample_device.mojo, kernels/test_sample_mask.mojo |
...
| `amar_topn_probs` | `sample.mojo` | `XLayout: TensorLayout, ILayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | topn_probs_k | serve/registry.mojo, kernels/test_sample_pen.mojo |
