94 kernels, 49 in registry, 1 orphans
ORPHAN: amar_sample_row_masked sample.mojo
 `amar_*` kernel
...
| `amar_sample_row_masked` | `sample.mojo` | `XLayout: TensorLayout, OLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` |  |  |
