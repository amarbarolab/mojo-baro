...
| `amar_matmul_skinny_q2b3row` | `matmul_ternary.mojo` | `MR: Int, ALayout: TensorLayout, QLayout: TensorLayout, SLayout: TensorLayout, PLayout: TensorLayout` |  | bench/bench_coldcache_ternary.mojo, kernels/test_ternary_gemm.mojo |
| `amar_matmul_skinny_tq1row` | `matmul_ternary.mojo` | `MR: Int, ALayout: TensorLayout, QLayout: TensorLayout, SLayout: TensorLayout, PLayout: TensorLayout` |  | bench/bench_coldcache_ternary.mojo, kernels/test_ternary_gemm.mojo |
| `amar_matmul_skinny_tq2row` | `matmul_ternary.mojo` | `MR: Int, ALayout: TensorLayout, QLayout: TensorLayout, SLayout: TensorLayout, PLayout: TensorLayout` |  | bench/bench_coldcache_ternary.mojo, kernels/test_ternary_gemm.mojo |
