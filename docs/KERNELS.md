...
| `amar_apply_penalties` | `sample.mojo` | `XLayout: TensorLayout, ILayout: TensorLayout, CLayout: TensorLayout, NLayout: TensorLayout` | apply_penalties_k | serve/registry.mojo, kernels/test_sample_pen.mojo |
| `amar_sample_probs` | `sample.mojo` | `XLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | sample_probs_k, sample_probs_1 | serve/registry.mojo, kernels/test_sample.mojo, kernels/test_sample_device.mojo, kernels/test_sample_mask.mojo |
| `amar_sample_probs_masked` | `sample.mojo` | `XLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` |  | kernels/test_sample_mask.mojo |
| `amar_sample_row` | `sample.mojo` | `XLayout: TensorLayout, OLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | sample_row_k, sample_row_1 | serve/registry.mojo, serve/engine.mojo, serve/spark.mojo, bench/sample-spark-device.mojo, kernels/test_sample.mojo, kernels/test_sample_device.mojo, kernels/test_sample_mask.mojo, kernels/test_sample_pen.mojo |
| `amar_sample_row_masked` | `sample.mojo` | `XLayout: TensorLayout, OLayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | sample_row_masked_k | serve/registry.mojo, serve/spark.mojo, kernels/test_sample_device.mojo, kernels/test_sample_mask.mojo |
...
| `amar_topn_probs` | `sample.mojo` | `XLayout: TensorLayout, ILayout: TensorLayout, PLayout: TensorLayout, CAP: Int = SAMP_CAP` | topn_probs_k | serve/registry.mojo, serve/spark.mojo, kernels/test_sample_pen.mojo |
...
| `amar_trace_sum` | `spark_kernels.mojo` | `` |  | serve/spark.mojo |
...
| `amar_ssm_delta_chunk_w` | `ssm.mojo` | `S0Layout: TensorLayout, CLayout: TensorLayout, GLayout: TensorLayout, OLayout: TensorLayout` | deltaw_p | serve/registry.mojo, kernels/test_prefill.mojo, kernels/test_ssm_rows.mojo |
| `amar_ssm_delta_rows` | `ssm.mojo` | `S0Layout: TensorLayout, CLayout: TensorLayout, GLayout: TensorLayout, OLayout: TensorLayout` | deltar_p | serve/registry.mojo, kernels/test_ssm_rows.mojo |
| `amar_ssm_delta_step` | `ssm.mojo` | `MR: Int, S0Layout: TensorLayout, CLayout: TensorLayout, GLayout: TensorLayout, OLayout: TensorLayout` |  | serve/registry.mojo, bench/bench_launch_floor.mojo, kernels/test_mega_block.mojo, kernels/test_prefill.mojo, kernels/test_ssm_block.mojo, kernels/test_ssm_rows.mojo |
...
| `test_expert_tier.mojo` | manual | B4 stage 2b gate 1: the tier's own LRU reproduces the offline replay. |
...
| `test_sample_mask.mojo` | run-tests.sh | Grammar-masked sampling: device kernels vs the host reference at real VOCAB width (briefs/2026-09-16-fable-masked-sampler.md). |
| `test_sample_pen.mojo` | run-tests.sh | Penalties and top-N logprobs: device kernels vs the host reference at real VOCAB width (briefs/2026-09-16-fable-sample-kernels.md). |
...
| `test_ssm_rows.mojo` | run-tests.sh | Parity: amar_ssm_delta_rows (one launch, m rows, state kept in registers) against amar_ssm_delta_step[1] launched once per row through the state ring, BIT-EXACT on the per-row outputs and on the final state slot. |
