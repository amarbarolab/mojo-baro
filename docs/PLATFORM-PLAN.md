...
same engine alone: each engine is compared with its own solo arm, never across engines (the two
run different models). Until P0b lands the split is a 20-line round-robin script and the receipt says
